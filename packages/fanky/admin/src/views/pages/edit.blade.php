...
<form action="{{ route('admin.pages.save') }}" onsubmit="return pageSave(this, event)">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            @if($page->id)
                <li class="pull-right">
                    <a href="{{ in_array($page->alias, \Fanky\Admin\Models\Page::$landing_aliases) ?
                                url('/catalog/landing/' . $page->alias) : $page->url }}"
                        ...
                        <div id="article-image-block">
                            @if ($page->image)
                                <img class="img-polaroid" src="{{ $page->thumb(1) }}" height="100"
                                     ...
                                     onclick="return popupImage($(this).data('image'))" alt="Изображение страницы">
                                <a class="images_del" href="{{ route('admin.pages.delete-image', $page->id) }}"
                                   onclick="return pageImageDel(this, event)">
