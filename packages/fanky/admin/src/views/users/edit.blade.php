<form action="{{ route('admin.users.save') }}" onsubmit="return userSave(this)">
	...
	<div class="row">
		<div class="col-md-7">
			<div class="form-group">
				...
				<input id="user-username" class="form-control"
	...
	<div class="form-group">
		...
		<input id="user-password" class="form-control"
			   type="password" name="password" value="" placeholder="{{ $user->id ? 'Изменить пароль' : '' }}">
	</div>
