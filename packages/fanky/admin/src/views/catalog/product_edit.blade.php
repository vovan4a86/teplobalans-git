...
{{--                {!! Form::groupText('article', $product->article, 'Артикул', ['disabled' => true]) !!}--}}
                ...
                <div class="row" style="display: flex;">
                    ...
                    <div class="col-sm-9">
                        {!! Form::groupText('sale_type', $product->sale_type, 'Тип продаж') !!}
                    </div>
                </div>
            ...
            <div class="tab-pane" id="tab_2">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {!! Form::groupRichtext('using', $product->using, 'Используется') !!}
                    </div>
                    <div class="col-sm-6">
                        {!! Form::groupRichtext('delivery', $product->delivery, 'Доставка') !!}
                    </div>
                </div>
                {!! Form::groupRichtext('text', $product->text, 'Текст') !!}

                <span style="color: orange; font-style: italic">Общие преимущества товаров можно изменить в Структуре сайта/Каталог/Настройки</span>
            </div>
