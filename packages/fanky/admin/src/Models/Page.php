...
class Page extends Model
{
    ...
    const TOP_VIEW_DEFAULT = '/static/images/common/top-view.jpg';
...
//    ];
    ...
    public static $excludeTextField = [
        ...
        'news',
        'about',
        'opori-osveshcheniya-i-svetilniki-iz-alyuminiya'
    ];

    public static $landing_aliases = [
        'opori-osveshcheniya-i-svetilniki-iz-alyuminiya'
    ];
    ...
    public function public_children_header(): HasMany
    {
        return $this->children()
            ->where('published', 1)
            ->where('on_header', 1)
