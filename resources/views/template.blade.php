                    ...
                    @foreach($workers as $worker)
                        <div class="card-usr">
                            ...
                            <div class="card-usr__body">
                                ...
                                <a class="card-usr__phone" href="tel:{{ SiteHelper::clearPhone($worker['phone']) }}"
                                   title="Позвонить нам">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                                        <g clip-path="url(#a)">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                  stroke-width="2"
                                                  d="M16.5 12.69v2.25a1.499 1.499 0 0 1-1.635 1.5 14.843 14.843 0 0 1-6.472-2.302 14.625 14.625 0 0 1-4.5-4.5A14.842 14.842 0 0 1 1.59 3.135 1.5 1.5 0 0 1 3.083 1.5h2.25a1.5 1.5 0 0 1 1.5 1.29 9.63 9.63 0 0 0 .525 2.108A1.5 1.5 0 0 1 7.02 6.48l-.952.953a12 12 0 0 0 4.5 4.5l.952-.953a1.5 1.5 0 0 1 1.582-.337c.681.253 1.388.43 2.108.525a1.5 1.5 0 0 1 1.29 1.522Z"
                                            />
                                        </g>
                                        <defs>
                                            <clipPath id="a">
                                ...
                                <div class="card-usr__actions">
                                    <btn class="btn btn--red btn-reset" type="button" data-popup="data-popup"
                                         data-src="#request"
    ...
    <section class="s-cont">
        <div class="s-cont__container">
                ...
                @if($contacts = S::get('contacts'))
                    <div class="s-cont__content">
                        <div class="s-cont__item">
                            ...
                            <a class="s-cont__value" href="tel:{{ SiteHelper::clearPhone($contacts['phone']) }}">
                                {{ $contacts['phone'] }}
                            </a>
                        </div>
                        <div class="s-cont__item">
                            <div class="s-cont__key">Отправить вопрос на почту</div>
                            <a class="s-cont__value" href="mailto:{{ $contacts['email'] }}">{{ $contacts['email'] }}</a>
                        </div>
                        <div class="s-cont__item">
                            <div class="s-cont__key">Адрес компании</div>
                            <div class="s-cont__value">{{ $contacts['address'] }}</div>
                        </div>
                        <div class="s-cont__item">
                            <div class="s-cont__key">График работы</div>
                            <div class="s-cont__value">{{ $contacts['schedule'] }}</div>
                        </div>
                        <div class="s-cont__item">
            ...
            @if($map = S::get('contacts_map'))
                <div class="s-cont__map" id="map-1" data-map="data-map"
                     data-lat="{{ $map['lat'] }}"
                     data-long="{{ $map['long'] }}"
                     data-hint="{{ $map['hint'] }}">
                </div>
