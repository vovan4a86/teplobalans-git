<footer class="footer lazy footer--light"
        data-bg="/static/images/common/footer-bg--light.jpg">
        ...
        <div class="footer__grid">
            <div class="footer__about">
                <div class="footer__logo">
                    @if(Route::is('main'))
                    <div class="logo">
                        <img class="logo__img no-select" src="/static/images/common/logo.svg" width="222"
                             height="60" alt="logo"/>
                    </div>
                    @else
                ...
                <div class="footer__info">
                    <div class="footer__data">
                        ...
                        <div class="footer__item footer__item--actions">
                            ...
                            <button class="action-btn btn-reset action-btn--black" type="button" data-popup="data-popup"
                                    data-src="#counselling" aria-label="Консультация">
                                <!--(errorPage ? "ico_talk--black.svg" : "ico_talk.svg")-->
                                <span class="action-btn__icon lazy" data-bg="/static/images/common/ico_talk--black.svg"></span>
